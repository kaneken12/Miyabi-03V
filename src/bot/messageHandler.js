const { shouldRespond, extractMessageText, isGroupMessage, getSenderName, normalizePhone } = require('../utils/helpers');
...
class MessageHandler {
    ...
    async handleCommand(messageText, message, sock) {
        const chatId = message.key.remoteJid;
        const sender = message.key.participant || message.key.remoteJid;
        const isCreator = normalizePhone(sender) === normalizePhone(this.bot.creator);
